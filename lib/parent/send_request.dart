...
class _sendRequestState extends State<sendRequest> {
  late TextEditingController _parentnameController, _parentphoneController, _bookseatsController,_startpointController,
  ...
  void saveProduct(){
    ...
    String totalseats = _startpointController.text;
    String reserveseats = _destinationController.text;
    String availableseats = _bookseatsController.text;
